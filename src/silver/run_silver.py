...
from common.config import load_silver_settings
from common.spark_session import create_spark_session
from silver.transform import transform_all_silver_tables


def run_silver_transformation(spark: SparkSession | None = None):
    ...
    result = transform_all_silver_tables(session, settings)
